...
// const isLeaf = (item) => !!item?.path && !Array.isArray(item?.subMenu);
...
// const Sidebar = ({ menuItems = null, onNavigate }) => {
//   const [searchTerm, setSearchTerm] = useState("");
//   const [isDarkMode, setIsDarkMode] = useState(false);

//   // internal fetch state (used only if menuItems prop not provided)
//   const [fetched, setFetched] = useState([]);
//   const [loading, setLoading]   = useState(false);
//   const [error, setError]       = useState("");

//   // self-fetch if no menuItems prop
//   useEffect(() => {
...
//   // choose data source: prop wins, otherwise fetched
//   const items = useMemo(() => {
