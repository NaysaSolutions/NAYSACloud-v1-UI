...
//   // Split by either | or ~ and trim every resulting part immediately
//   const parts = String(groupId).split(/[|~]/).map(p => p.trim());
  
//   // If no split occurred (length is 1), or the original didn't have delimiters
...
//         slName: "",
//         cutoffStartCode: decoded.cutOffCode,
//         cutoffStartName: fSPeriod.cutoffName || "",
//         cutoffEndCode: decoded.cutOffCode,
//         cutoffEndName: fPeriod.cutoffName || "",
//         rcCode: "",
//         rcName: "",
//         rcCodeStart: fRC.rcCode || "",
//         rcNameStart: fRC.rcName || "",
//         rcCodeEnd: fRC.rcCode || "",
//         rcNameEnd: fRC.rcName || "",
//       };
...
//                   return (
//                     <div key={tabKey} className={tabKey === activeTab ? "block" : "hidden"}>
//                       {!view.hasLoaded ? (
...
//           <ReportNavList activeTab={activeTab} handleSelect={handleSelect} tabConfigs={tabConfigs} />
//         </div>

//         <div className="pt-4 border-t mt-4 text-xs text-gray-500">
//           <p className="font-semibold mb-1">Hint:</p>
//           <p>
//             Tap a report, then use the <span className="font-semibold">Filter</span> button at the
//             top to set your filters.
//           </p>
//         </div>
//       </div>
//     </div>
