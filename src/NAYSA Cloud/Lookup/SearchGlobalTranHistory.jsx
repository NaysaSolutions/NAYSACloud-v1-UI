...
// import {
//   faList, faPen, faCalendarAlt, faFilter, faDownload, faRedo, faArrowUp, faArrowDown,faSpinner
...
//     const jsonData = toTabbedJson(reportName, start, end, sheets); 
//     const payload = {
...
//     try {
//       const res = await apiClient.post("/exportHistoryReport", payload, {
//         responseType: "blob",
//       });
...
import React, { useState, useEffect, useCallback, useMemo, useRef } from "react";
import { apiClient, postRequest } from "@/NAYSA Cloud/Configuration/BaseURL";
import { subDays, format } from "date-fns";
import DatePicker from "react-datepicker";
import "react-datepicker/dist/react-datepicker.css";
import Modal from "react-modal";
